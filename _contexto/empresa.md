...
**Equipe:** Solo + assistente virtual chamado Merlin
**Ferramentas:** Canva, Trello, Zoom, WhatsApp, Magnific, Mailchimp
**Principais entregas:**
...
- Gestão de redes sociais + conteúdo
- Workshops e Treinamentos de Marketing e IA

## Oferta em camadas

- **Layer 1 — Foundation:** Planejamento estratégico. Diagnóstico, posicionamento, ICP, proposta de valor, metas, funil, canais, calendário. Output: plano 30/60/90 dias.
- **Layer 2 — Conversion:** Conteúdo e copy, audit de perfil, landing pages, fluxos de conversão.
- **Layer 3 — Scale:** Mídia paga (Meta/Google), email nurture, website, automações leves. Mensal / projeto.
